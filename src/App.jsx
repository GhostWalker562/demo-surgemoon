        ...
        <Header style={styles.header}>
          ...
          >
            <Menu.Item key="quickstart">
              <NavLink to="/quickstart">🚀 Secret Image </NavLink>
            </Menu.Item>
      ...
      <Footer style={{ textAlign: "center" }}>
        <Text style={{ display: "block" }}>
          ...
          <a
            ...
            href="https://www.youtube.com/c/MOONSDONTBURN"
          >
            MOONSDONTBURN
          </a>
        </Text>
        ...
        {/* <Text style={{ display: "block" }}>
          💰 Interested in trying out crypto subscriptions? Contact me at{" "}
          <a
            target="_blank"
            rel="noopener noreferrer"
            href="moonsdontburn@outlook.com"
          >
            moonsdontburn@outlook.com
        </Text> */}
      </Footer>
    </Layout>
  );
